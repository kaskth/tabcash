...
import {transferToWallet,transferToSmartCard} from "../4_shared_utilities_layer/transformation.js";
...
app.patch('/transfer/to-smartCard',async (req,res)=>{
    ...
    try {
        ...
        // transfer
        await transferToSmartCard(user.wallet,amount)
